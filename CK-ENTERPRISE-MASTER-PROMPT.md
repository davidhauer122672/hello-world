...
├── th-sentinel-campaign/        Retell/Atlas campaign configs (8 campaigns)
...
**Atlas AI Campaigns:** `GET /v1/atlas/campaigns`, `GET /v1/atlas/campaigns/:id`, `PUT /v1/atlas/campaigns/:id/status`, `GET /v1/atlas/statistics`, `GET /v1/atlas/campaigns/:id/stats`, `GET /v1/atlas/campaigns/:id/calls`, `GET /v1/atlas/campaigns/:id/calls/:callId`, `POST /v1/atlas/campaigns/:id/schedule`, `GET /v1/atlas/campaigns/:id/bookings`, `GET /v1/atlas/kb/files`, `POST /v1/atlas/speed-to-lead`, `POST /v1/atlas/campaigns`, `GET /v1/atlas/audit`, `GET /v1/atlas/health`
...
| **Retell AI / Atlas** | Live | 8 campaign types, 40 voice agents, youratlas.com |
...
**Speed-to-Lead:** `POST /v1/atlas/speed-to-lead` — 60-second callback target, 3 retries, fallback to drip
...
| 9 | ATLAS_API_KEY on Express host | CEO | 5 min | Pending |
