...
export function renderLeads() {
  ...
  return `
    ...
    <div class="card-glass mb-md" style="padding:var(--space-md);display:flex;gap:var(--space-sm);">
      <input type="search" placeholder="Search leads..." style="flex:1;background:var(--ck-surface);border:1px solid var(--ck-border);border-radius:var(--radius-md);padding:10px 14px;color:#fff;font-size:0.85rem;font-family:var(--font-body);outline:none;" />
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--space-xs);margin-bottom:var(--space-lg);">
      <div class="card" style="padding:var(--space-sm);text-align:center;">
        <div style="font-size:1.1rem;font-weight:700;color:var(--ck-red);">18</div>
        <div class="text-xs text-dim">Hot</div>
      </div>
      <div class="card" style="padding:var(--space-sm);text-align:center;">
        <div style="font-size:1.1rem;font-weight:700;color:var(--ck-amber);">43</div>
        <div class="text-xs text-dim">Warm</div>
      </div>
      <div class="card" style="padding:var(--space-sm);text-align:center;">
        <div style="font-size:1.1rem;font-weight:700;color:var(--ck-blue);">89</div>
        <div class="text-xs text-dim">Cool</div>
      </div>
      <div class="card" style="padding:var(--space-sm);text-align:center;">
        <div style="font-size:1.1rem;font-weight:700;color:#71717a;">97</div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-sm);">
      <button class="btn btn-execute" style="font-size:0.75rem;padding:12px;">Score All Leads</button>
