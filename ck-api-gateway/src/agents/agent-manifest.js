 ...
 *
 * Fleet Composition: 404 Total Units
 *   - 333 Division Agents (12 divisions: MCCO, EXC, SEN, OPS, INT, MKT, FIN, VEN, TEC, WEB, COOP, CDX)
 ...
 *   CEO (Human) → MCCO-000 Sovereign → CMO → MKT (48) + SEN (40)
...
export const DIVISIONS = {
  MCCO: {
    ...
    description: 'Sovereign-level governance commanding all marketing and sales operations. Ferrari-standard execution across MKT (48 agents) and SEN (40 agents).',
    governs: ['MKT', 'SEN'],
    squads: {
