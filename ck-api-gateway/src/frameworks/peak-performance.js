...
export const JOBS_SALES_RULES = {
  ...
  applicationToPropertyManagement: {
    uvp: 'Coastal Key is the ONLY AI-powered property management company on the Treasure Coast with a 404-agent autonomous fleet.',
    ...
    compellingStory: 'Share the founder journey — from frustration with traditional property management to building a 404-agent AI fleet.',
...
export const FLOW_STATE_FRAMEWORK = {
  ...
  applicationToPropertyManagement: {
    ...
    challenging: 'Scaling a 404-agent AI fleet while maintaining Ferrari-standard quality is the right level of difficulty.',
