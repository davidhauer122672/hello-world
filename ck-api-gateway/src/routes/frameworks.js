...
## Context:
Coastal Key is an AI-leveraged home watch and property management company on Florida's Treasure Coast, commanding a fleet of 404 autonomous AI agents across 12 divisions. The company serves absentee homeowners, seasonal residents, luxury investors, and snowbirds.
...
## Context:
Coastal Key Property Management — AI-leveraged home watch and property management on Florida's Treasure Coast. 404-agent autonomous AI fleet. Serves absentee homeowners, seasonal residents, luxury investors, snowbirds.
...
## Context:
Coastal Key — AI-leveraged home watch and property management, Treasure Coast Florida. 404-agent AI fleet. 40 Sentinel Sales agents making 2,400+ calls daily via Retell AI.
...
Build a comprehensive productivity optimization plan for ${division ? `the ${division} division` : 'the entire 404-agent fleet'} at Coastal Key Property Management.
