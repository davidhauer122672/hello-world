...
const INTELLIGENCE_OFFICERS = [
  ...
  { id: 'IO-E05', name: 'Fleet Utilization', squad: 'ECHO', role: 'Agent Fleet Utilization', description: 'Monitors the 404-agent fleet utilization rates — identifies idle agents and overloaded divisions.', monitoringTarget: 'fleet_utilization', scanInterval: 60, status: 'active', severity: 'medium' },
