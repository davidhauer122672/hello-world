...
export function getBusinessModel() {
  return {
    ...
    differentiator: 'Only platform combining 383-agent fleet with productized enterprise AIOS delivery.',
    competitiveAdvantage: [
      'Largest privately deployed AI agent fleet (383 units)',
      ...
      'Multi-division operational coverage (10 divisions)',
    ],
  };
}
