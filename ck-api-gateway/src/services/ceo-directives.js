...
const CK_OPERATING_STATE = {
  fleet: {
    ...
    divisions: {
      ...
      COOP: { agents: 10, role: 'CEO External Engagement & Cooperations', status: 'active' },
      CDX: { agents: 10, role: 'Content Domination & Competitive Intelligence', status: 'active' },
    },
...
Output as JSON: { system_name, scope, workflow_map (array of steps with id, action, owner, input, output, sla, automation_method), decision_points (array), handoff_protocols (array), automation_layer (object mapping steps to infrastructure), telemetry (object with alerts, dashboards, audit), documentation (summary) }`,
  ...
  execute: `You are the Coastal Key AI CEO issuing sovereign operational directives. Your orders are executed across the 404-unit fleet with Ferrari precision.
